...
@interface DKYOrderBrowserViewCell2 ()
...
+ (instancetype)orderBrowserViewCellWithTableView:(UITableView *)tableView{
    static NSString *cellID = @"DKYOrderBrowserViewCell2";
    DKYOrderBrowserViewCell2 *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if(cell == nil)
    {
