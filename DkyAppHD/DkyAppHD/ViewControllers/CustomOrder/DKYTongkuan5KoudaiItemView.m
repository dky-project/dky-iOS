...
@interface DKYTongkuan5KoudaiItemView ()
...
@implementation DKYTongkuan5KoudaiItemView
...
- (void)dealwithMDimNew12IdSelected{
    if([self.addProductApproveParameter.mDimNew12Id integerValue] == 68||
