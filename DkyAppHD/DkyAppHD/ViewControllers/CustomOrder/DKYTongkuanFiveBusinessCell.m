...
@interface DKYTongkuanFiveBusinessCell ()
...
@implementation DKYTongkuanFiveBusinessCell

+ (instancetype)customOrderBusinessCellWithTableView:(UITableView *)tableView{
    static NSString *cellID = @"DKYTongkuanFiveBusinessCell";
    DKYTongkuanFiveBusinessCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if(cell == nil)
    {
        cell = [[DKYTongkuanFiveBusinessCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
    }
    return cell;
}
