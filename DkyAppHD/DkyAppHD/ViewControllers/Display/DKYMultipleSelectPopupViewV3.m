//
//  DKYMultipleSelectPopupViewV3.m
//  DkyAppHD
//
...
@interface DKYMultipleSelectPopupViewV3 ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DKYMultipleSelectPopupViewV3

+ (instancetype)show{
    DKYMultipleSelectPopupViewV3 *contentView = [[DKYMultipleSelectPopupViewV3 alloc]initWithFrame:CGRectZero];
...
- (void)fetchSelectedColorInfo{
    ...
    if(selectedColor.count > 0){
        self.addDpGroupApproveParam.colorArr = [selectedColor componentsJoinedByString:@";"];
    }else{
