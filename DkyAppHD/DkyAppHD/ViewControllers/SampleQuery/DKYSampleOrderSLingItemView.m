...
#import "DKYSampleOrderOneView.h"

@interface DKYSampleOrderSLingItemView ()
...
@property (nonatomic, weak) DKYSampleOrderOneView *oneView;
...
@implementation DKYSampleOrderSLingItemView
...
- (void)setupOneView{
    DKYSampleOrderOneView *view = [[DKYSampleOrderOneView alloc] initWithFrame:CGRectZero];
