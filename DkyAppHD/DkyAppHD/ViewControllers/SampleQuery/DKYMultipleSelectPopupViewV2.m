//
//  DKYMultipleSelectPopupViewV2.m
//  DkyAppHD
//
...
@interface DKYMultipleSelectPopupViewV2 ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DKYMultipleSelectPopupViewV2

+ (instancetype)show{
    DKYMultipleSelectPopupViewV2 *contentView = [[DKYMultipleSelectPopupViewV2 alloc]initWithFrame:CGRectZero];
